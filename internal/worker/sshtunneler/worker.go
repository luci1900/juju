...
func (a *connRequestStateAdapter) InsertSSHConnRequest(ctx context.Context, req domainssh.SSHConnRequest) error {
	svc, err := a.getSSHService(ctx, a.domainServicesGetter, req.ModelUUID)
	if err != nil {
