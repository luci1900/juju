...
// GetSSHHostKeyServiceFunc is a helper function that gets an SSH host key
...
// GetSSHHostKeyService is a helper function that gets the SSH host key service
// from the manifold.
